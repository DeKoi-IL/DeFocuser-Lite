; AppV2 installer — DeFocuser Lite (WPF)
; Bundles the ASCOM driver DLL + the WPF mediator app.
; SourceDir resolves to the repository root.
...
WizardImageFile="Code\Installer\WizardImageFile.bmp"
...
; AppV2 WPF Controller EXE (owns serial connection, serves ASCOM clients)
Source: "AppV2\bin\x64\Release\ASCOM.DeKoi.DeFocuserApp.exe"; DestDir: "{app}"
Source: "AppV2\bin\x64\Release\ASCOM.DeKoi.DeFocuserApp.exe.config"; DestDir: "{app}"
